...
GOLDEN_DATASET = [
    EvalExample(
        ...
        expected_answer_keywords=["nedvesség", "duzzadás", "repedés", "aljzatkiegyenlítő", "statikai"],
    ...
    EvalExample(
        ...
        expected_answer_keywords=["gépészet", "vízvezeték", "elzárás", "amerikai konyha", "strang"],
    ...
    EvalExample(
        ...
        expected_answer_keywords=["alumínium", "vezeték", "csere", "földelés", "fi-relé"],
