...
def extract_metadata_from_notes(
    ...
    for pattern in TIMELINE_PATTERNS:
        ...
        if match:
            ...
            try:
                ...
                v2 = float(groups[1].replace(",", ".")) if len(groups) > 1 and groups[1] else v1
    ...
    if "fizetési" in combined_notes.lower() or "%" in combined_notes:
        ...
        schedule_lines = [l.strip() for l in lines if "%" in l or "fizetés" in l.lower()]
        if schedule_lines:
