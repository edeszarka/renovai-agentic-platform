...
def render_report_md(report: AdvisoryReport) -> str:
    ...
    risk_emoji = {"alacsony": "🟢", "közepes": "🟡", "magas": "🔴"}.get(report.overall_risk, "❓")
    ...
    md += f"| **Várható** | {report.cost_estimate['estimate_mid_huf']:,} Ft |\n".replace(",", " ")
    ...
    def render_items(items: list[ChecklistItem], title: str):
        ...
        # Sort by priority
        for prio, emoji in [("kritikus", "🔴"), ("fontos", "🟡"), ("érdemes_megnézni", "🔵")]:
