...
def main():
    ...
    parser.add_argument("--transcripts-dir", type=str, default="data/raw/video_transcripts/", help="Video transcript TXT directory")
    ...
    if transcript_chunks:
        console.print(f"Transcript chunks generated: [green]{len(transcript_chunks)}[/green]")
