...
async def main():
    parser = argparse.ArgumentParser(description="RenovAI SQL Natural Language Query — Module 1b")
    ...
    while True:
        try:
            ...
            with console.status("[bold green]SQL generálása és futtatása...[/bold green]"):
