...
from renovai.predictor.feature_extractor import (
    extract_features, build_feature_matrix, apartment_input_to_features, ApartmentInput, QuoteFeatures
)
from renovai.predictor.price_model import train_model, predict, find_similar_quotes
from renovai.ingestion.inflation_models import PriceIndex, CPIRecord
...
def test_train_model_runs(tmp_path):
    X = pd.DataFrame([
        {"district": 1, "total_area_sqm": 50, "num_rooms": 1, "has_plumbing_work": True, "has_electrical_work": True, "has_flooring_work": True, "has_demolition": True, "has_slag_complication": False, "num_line_items": 10, "labor_to_material_ratio": 1.1, "demolition_cost_share": 0.1, "plumbing_cost_share": 0.2},
        {"district": 2, "total_area_sqm": 60, "num_rooms": 2, "has_plumbing_work": True, "has_electrical_work": False, "has_flooring_work": True, "has_demolition": False, "has_slag_complication": True, "num_line_items": 12, "labor_to_material_ratio": 1.2, "demolition_cost_share": 0.0, "plumbing_cost_share": 0.3},
        {"district": 3, "total_area_sqm": 70, "num_rooms": 3, "has_plumbing_work": False, "has_electrical_work": True, "has_flooring_work": False, "has_demolition": True, "has_slag_complication": False, "num_line_items": 8, "labor_to_material_ratio": 1.0, "demolition_cost_share": 0.2, "plumbing_cost_share": 0.0},
        {"district": 4, "total_area_sqm": 80, "num_rooms": 3, "has_plumbing_work": True, "has_electrical_work": True, "has_flooring_work": True, "has_demolition": True, "has_slag_complication": False, "num_line_items": 15, "labor_to_material_ratio": 1.3, "demolition_cost_share": 0.15, "plumbing_cost_share": 0.25},
        {"district": 5, "total_area_sqm": 40, "num_rooms": 1, "has_plumbing_work": False, "has_electrical_work": False, "has_flooring_work": True, "has_demolition": False, "has_slag_complication": False, "num_line_items": 5, "labor_to_material_ratio": 0.9, "demolition_cost_share": 0.0, "plumbing_cost_share": 0.0}
    ])
...
def test_predict_with_inflation(mock_load, tmp_path):
    ...
    feat = QuoteFeatures(
        district=1, has_plumbing_work=True, has_electrical_work=True, has_flooring_work=True, has_demolition=True, 
        has_slag_complication=False, num_line_items=10, num_versions=1, labor_to_material_ratio=1.0, 
        demolition_cost_share=0.1, plumbing_cost_share=0.2
    )
    
    index = PriceIndex(
        materials=[CPIRecord(year=2024, quarter=1, index_value=1.0), CPIRecord(year=2025, quarter=1, index_value=1.2)],
        labor=[CPIRecord(year=2024, quarter=1, index_value=1.0), CPIRecord(year=2025, quarter=1, index_value=1.1)],
